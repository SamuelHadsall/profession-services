...
class Location {
    ...
    public function ps_create_location_cpt() {
        $options = [
            'name' => __( 'Locations',  $this->plugin_name ),
            'singular_name'  => __( 'Location', $this->plugin_name ),
        ...
        $locations = new PostType('locations', $options);
    ...
    public function ps_create_cpt_display_callback( $post ) {
        ...
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'helpers/meta-box/locations-edit-area.php';
    }
