...
class Area {
    ...
    public function ps_create_area_cpt() {
        $options = [
            'name' => __( 'Area',  $this->plugin_name ),
            'singular_name'  => __( 'Area', $this->plugin_name ),
        ...
        $area = new PostType('area', $options);
    ...
    public function ps_create_cpt_display_callback( $post ) {
        ...
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'helpers/meta-box/service-area-edit-area.php';
    }
    ...
    public function ps_register_block_init() {
        require_once WP_PLUGIN_DIR . '/' . $this->plugin_name . '/includes/blocks/service-area.php';
    }
}
