...
class Clients {
    ...
    public function ps_create_client_cpt() {
        $options = [
            'name' => __( 'Cients',  $this->plugin_name ),
        ...
        $clients = new PostType('clients', $options);
    ...
    public function ps_create_cpt_display_callback( $post ) {
        ...
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'helpers/meta-box/clients-edit-area.php';
    }
    ...
    public function ps_create_cpt_meta_boxes_save( $post_id ) {
        ...
        $fields = [
            'ps-client-icon',
            'ps-client-description',
            'ps-client-business-sector',
            'ps-client-industry'
        ];
