...
class Business_Sectors {
    ...
    public function ps_create_business_sector_cpt() {
        $options = [
            'name' => __( 'Business Sector',  $this->plugin_name ),
            'singular_name'  => __( 'Business Sector', $this->plugin_name ),
            'add_new' => __( 'Add New Business Sector', $this->plugin_name ),
            'add_new_item' => __( 'Add New Business Sector', $this->plugin_name ),
        ...
        $busines_sectors = new PostType('business_sectors', $options);

        $busines_sectors->register();
    }
    ...
    public function ps_create_cpt_display_callback( $post ) {
        ...
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'helpers/meta-box/business-sector-edit-area.php';
    }
    ...
    public function ps_create_cpt_meta_boxes_save( $post_id ) {
        ...
        $fields = [
            'ps-business-sector-image',
            'ps-business-sector-description'
        ];
