...
class Articles {
    ...
    public function ps_create_article_cpt() {
        $options = [
            'name' => __( 'Articles',  $this->plugin_name ),
            'singular_name'  => __( 'Article', $this->plugin_name ),
        ...
        $articles = new PostType('articles', $options);
    ...
    public function ps_create_cpt_display_callback( $post ) {
        ...
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'helpers/meta-box/articles-edit-area.php';
    }
