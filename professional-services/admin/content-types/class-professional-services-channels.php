...
class Channels {
    ...
    public function ps_create_channel_cpt() {
        $options = [
            'name' => __( 'Channels',  $this->plugin_name ),
            'singular_name'  => __( 'Channel', $this->plugin_name ),
        ...
        $channels = new PostType('channels', $options);
    ...
    public function ps_create_cpt_display_callback( $post ) {
        ...
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'helpers/meta-box/channels-edit-area.php';
    }
