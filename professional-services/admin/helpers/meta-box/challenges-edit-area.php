<div class="ps-meta-box">
    ...
    <div class="meta-options ps-meta-box-field">
        <label for="ps-challenge-image">Image</label>
        <?php $image = get_post_meta( get_the_ID(), 'ps-challenge-image', true ); ?>
        <div class="file-uploaded list-image-uploaded <?php echo $image != null ? '' : 'hidden'; ?>">
            ...
            <input type="hidden" name="ps-challenge-image" value="<?php echo esc_attr($image); ?>" class="icon-img" />
        </div>
        <div class="file-upload <?php echo $image ? 'hidden' : ''; ?>">
            <div class="file-upload-add-file add-file add-list-image">
                <label for="ps-challenge-image" data-tooltip="Click To Add File">
    ...
    <div class="meta-options ps-meta-box-field">
        <label for="ps-challenge-description">Page Description</label>
        <?php
            $detail_content   = get_post_meta( get_the_ID(), 'ps-challenge-description', true );
            $detail_id = 'ps-challenge-description';
