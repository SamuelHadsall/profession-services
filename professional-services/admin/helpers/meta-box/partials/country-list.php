...
<option value="AI" <?php selected( $country, 'AI' ); ?>>Antarctica</option>
...
<option value="BO" <?php selected( $country, 'BO' ); ?>>Bolivia, Plurinational State of</option>
<option value="BQ" <?php selected( $country, 'BQ' ); ?>>Bonaire, Sint Eustatius and Saba</option>
...
<option value="CI" <?php selected( $country, 'CI' ); ?>>Côte d'Ivoire</option>
<option value="HR" <?php selected( $country, 'HR' ); ?>>Croatia</option>
<option value="CU" <?php selected( $country, 'CU' ); ?>>Cuba</option>
<option value="CW" <?php selected( $country, 'CW' ); ?>>Curaçao</option>
...
<option value="LY" <?php selected( $country, 'LY' ); ?>>Libya</option>
...
<option value="RE" <?php selected( $country, 'RE' ); ?>>Réunion</option>
...
<option value="BL" <?php selected( $country, 'BL' ); ?>>Saint Barthélemy</option>
<option value="SH" <?php selected( $country, 'SH' ); ?>>Saint Helena, Ascension and Tristan da Cunha</option>
...
<option value="MF" <?php selected( $country, 'MF' ); ?>>Saint Martin (French part)</option>
...
<option value="SX" <?php selected( $country, 'SX' ); ?>>Sint Maarten (Dutch part)</option>
...
<option value="SS" <?php selected( $country, 'SS' ); ?>>South Sudan</option>
...
<option value="VE" <?php selected( $country, 'VE' ); ?>>Venezuela, Bolivarian Republic of</option>
